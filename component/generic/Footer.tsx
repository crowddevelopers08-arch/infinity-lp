  ...
  return (
    <footer className="relative overflow-hidden bg-[#171415] font-[family-name:var(--font-merriweather)] text-white">
      ...
      <div className="relative mx-auto max-w-[1440px] px-5 pb-4 pt-12 sm:px-8 sm:pt-16 lg:px-16 xl:px-20">
            ...
            <ul className="mt-5 space-y-4 text-sm leading-relaxed text-white/60">
              ...
              <li className="flex items-start gap-3">
                ...
                <address className="not-italic">
                  ...
                  Shop No. 5, 1st Floor Besides Shri Ramkrishna Netralaya, DOSTI
                  IMPERIA, Ghodbunder Rd, opposite R-Mall, Manpada, Thane West,
                  Thane, Maharashtra 400607 Thane, India, 400607
                </address>
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col gap-3 max-sm:pb-15 pt-3 text-xs text-white/45 sm:flex-row sm:items-center sm:justify-between">
          <p>
            © 2026 M/S INFINITY MEDISURGE & AESTHETICS LLP . All rights
            reserved.
          </p>
          <a
            href="/privacy-policy"
