...
const photos = [
  { src: "https://res.cloudinary.com/x6ec5hqm/image/upload/v1786695490/doctor1.png", alt: "Infinity Aesthetics Clinic interior", cell: "col-span-3 row-span-6 col-start-1 row-start-1" },
  ...
  { src: "https://res.cloudinary.com/x6ec5hqm/image/upload/v1786695501/img-4.webp", alt: "Infinity Aesthetics Clinic treatment room", cell: "col-span-3 row-span-6 col-start-6 row-start-1" },
  ...
  { src: "https://res.cloudinary.com/x6ec5hqm/image/upload/v1786695501/img-6.webp", alt: "Clinic equipment and facilities", cell: "col-span-2 row-span-3 col-start-9 row-start-4" },
  { src: "https://res.cloudinary.com/x6ec5hqm/image/upload/v1786695502/img-7.webp", alt: "Welcoming clinic environment", cell: "col-span-2 row-span-3 col-start-11 row-start-4" },
]
