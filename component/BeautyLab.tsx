...
const FEATURES = [
  {
    ...
    icon: "https://res.cloudinary.com/muif2bou/image/upload/v1790064921/our-icon-1.png",
  },
  {
    ...
    icon: "https://res.cloudinary.com/muif2bou/image/upload/v1790064922/our-icons-2.png",
  },
  {
    ...
    icon: "https://res.cloudinary.com/muif2bou/image/upload/v1790064922/our-icon-3.png",
  },
  {
    ...
    icon: "https://res.cloudinary.com/muif2bou/image/upload/v1790064922/our-icons-4.png",
    accent: true,
  },
]
  ...
  return (
    <div className={`relative w-full pb-20 lg:pb-14 ${className}`}>
      <div className="relative aspect-[1.5/1] overflow-hidden">
        <Image
          src="https://res.cloudinary.com/muif2bou/image/upload/v1790064529/clinic-images.jpg"
