    ...
    <main className="min-h-screen bg-[#fffafa] font-[family-name:var(--font-merriweather)] text-[#231f20]">
      <header className="border-b border-[#eadfe0] bg-white">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-5 py-5 sm:px-8">
          <Link href="/hair-transplant" aria-label="Infinity Aesthetics Clinic home">
            <Image src="https://res.cloudinary.com/muif2bou/image/upload/v1790064922/logo.png" alt="Infinity Aesthetics Clinic" width={170} height={60} className="h-12 w-auto object-contain" priority />
          </Link>
          <Link href="/hair-transplant" className="inline-flex items-center gap-2 text-sm font-bold text-[#62595c] transition-colors hover:text-[#f52227]">
